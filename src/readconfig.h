...
rc_real rc_get_real(rc_data *data, char *param, int *status);
...
int *rc_get_int_vector(rc_data *data, char *param, int *length);

/* As rc_get_int_vector() but with reals. */
rc_real *rc_get_real_vector(rc_data *data, char *param, int *length);
...
rc_real **rc_get_real_matrix(rc_data *data, char *param, int *m, int *n);
...
int rc_assign_real(rc_data *data, char *param, rc_real *value);
...
int rc_assign_real_vector(rc_data *data, char *param,
...
/* As rc_assign_real_vector() except that if no reals are found then
   ...
   returned. */
int rc_assign_real_vector_default(rc_data *data, char *param,
